...
function HometypeFilter(props) {
  ...
  function confirmCart() {
    ...
    newUpdateCart[index2].soLuong =
      document.querySelector("#modisoluongCart").value;
    props.changeCart2(newUpdateCart);
    props.up();
  }
  ...
  let a1 = window.location.href.replace(
    "http://localhost:3000/product/filter/home?",
    ""
  );
  ...
  var myJSON = JSON.parse(
    JSON.stringify(handleDataFollowFiler(props.dataval, a3))
  );
  myJSON.sort((a, b) => {
  ...
  return (
    <div>
          ...
          <div class="row sm-gutter app__content">
            <div class="col l-12 m-12 c-12">
              <div class="home-filter hide-on-moble-tablet">
                ...
                <button
                  class="home-filter_btn btn commonButton"
                  onClick={(e) => {
                    sortCommon(e);
                  }}
                >
                ...
                <button
                  class="home-filter_btn btn newestButton"
                  onClick={(e) => {
                    sortNewst(e);
                  }}
                >
                ...
                <button
                  class="home-filter_btn btn salestButton"
                  onClick={(e) => {
                    sortBestSale(e);
                  }}
                >
                ...
                <div class="select-input">
                  ...
                  <i class="home-filter-select-icon fas fa-chevron-down"></i>
                  {/* <!-- List option sort  --> */}
                  <ul class="select-input__list">
                    <li class="select-input__item">
                      <button
                        class="select-input__link IncressePrice"
                        onClick={(e) => {
                          sortIncressePrice(e);
                        }}
                      >
                    ...
                    <li class="select-input__item">
                      <button
                        class="select-input__link DicreasePrice"
                        onClick={(e) => {
                          sortDicreasePrice(e);
                        }}
                      >
              ...
              <nav class="mobile-category">
                <ul class="mobile-category__list">
                  ...
                  <li class="mobile-category__item">
                    <a class="mobile-category__link">Dụng cụ nhà bếp</a>
                  </li>
                  <li class="mobile-category__item">
                    <a class="mobile-category__link">
              ...
              <div class="home-product">
                <div class="row sm-gutter">
                  ...
                  {stateSort.map((val, i) => {
                    return (
                      <div class="col l-2-4 m-4 c-6" key={i}>
                        <button
                          onClick={() => {
                            props.updateChimuc(i);
                            movePage(
                              removeAccents(val.ProductName).split(" ").join("")
                            );
                          }}
                        ...
                        >
                          <div
                            ...
                            style={{
                              backgroundImage: `url(${val.productPic[0]}) `,
                            }}
                          ></div>
                          ...
                          <div class="home-product-item__price">
                            <div className="home-product-item__price-wrap">
                              ...
                              <span class="home-product-item__price-curr">
                                {(
                                  (val.price *
                          ...
                          <div class="home-product-item__action">
                            ...
                            <div class="home-product-item_sold">
                  ...
                  <div class="col l-2-4 m-4 c-6"></div>
                </div>
              </div>
              {/* <!-- thanh đánh trang --> */}
      ...
      {props.data.map((val, i) => {
        return (
          <tr key={i}>
            ...
            <td>
              <img class="image-product" src={val.Img} alt="" />
            </td>
      ...
      <tr id="tfootadd">
        <td colSpan="9">
          <button onClick={add} id="tfootadd_button">
            +
          </button>
        </td>
      </tr>
      ...
      <div className="budget gioHang">
        Ngân sách: <b>{props.wallet}</b>{" "}
