...
function ResetPassword() {
  ...
  async function updatePassword() {
    ...
    let newPassword1 = document
      .querySelector(".password_newagain")
      .value.trim();
    if (password === "") {
