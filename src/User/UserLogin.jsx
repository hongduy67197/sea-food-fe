...
function UserLogin(props) {
  ...
  function loginShowPass() {
    document
      .querySelector(".login_conter_modal_password")
    ...
    <>
        ...
        <div className="login_conter">
          <div className="login_conter_modal">
            ...
            <img
              src={showPass2}
              alt="img"
              className="login_password_show1"
              onClick={loginShowPass}
            />
            <img
              src={showPass1}
              alt="img"
              className="login_password_show3"
              onClick={loginNoShowPass}
            />
            ...
            <div className="login_conter_modal_a">
              <Link to="/User/UserPage/ForgotPassword/ForgotPassword">
                Quên mật khẩu
              </Link>
      ...
      <div className="login_phone">
        ...
        <div className="login_phone_conter">
          ...
          <button className="login_phone_login" onClick={phone_login}>
            Login
          </button>
